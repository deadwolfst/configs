...
Module {
    ...
    property string libFilePathRelease: "/home/kirill/Qt5.7.0/5.7/android_armv7/lib/libQt5Core.so"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a", "/opt/android/ndk/platforms/android-9/arch-arm//usr/lib"]
    ...
    cpp.includePaths: {
        var paths = ["/home/kirill/Qt5.7.0/5.7/android_armv7/include", "/home/kirill/Qt5.7.0/5.7/android_armv7/include/QtCore"];
